...
1. SHOULD: Service implementations SHOULD extract user identity from JWT tokens rather than accepting user identifiers as direct parameters for authenticated operations

## Policy Block

- SHOULD Service implementations SHOULD extract user identity from JWT tokens rather than accepting user identifiers as direct parameters for authenticated operations
