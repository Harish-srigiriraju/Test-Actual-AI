...
1. MUST: All web request handlers MUST be implemented as Spring MVC @Controller or @RestController annotated classes

## Policy Block

- MUST All web request handlers MUST be implemented as Spring MVC @Controller or @RestController annotated classes
