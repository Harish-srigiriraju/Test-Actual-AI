...
1. MAY: Services MAY cache validated token claims for the duration of a single request to optimize performance

## Policy Block

- MAY Services MAY cache validated token claims for the duration of a single request to optimize performance
