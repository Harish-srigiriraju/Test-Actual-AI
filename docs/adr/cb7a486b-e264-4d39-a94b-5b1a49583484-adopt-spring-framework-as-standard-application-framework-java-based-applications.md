...
1. MUST: All Java-based applications MUST use Spring Framework as the primary application framework for dependency injection, configuration management, and core infrastructure

## Policy Block

- MUST All Java-based applications MUST use Spring Framework as the primary application framework for dependency injection, configuration management, and core infrastructure
