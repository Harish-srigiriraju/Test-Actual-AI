...
1. MUST: Service implementations MUST use the relational database for all CRUD operations on domain entities rather than alternative storage mechanisms

## Policy Block

- MUST Service implementations MUST use the relational database for all CRUD operations on domain entities rather than alternative storage mechanisms
