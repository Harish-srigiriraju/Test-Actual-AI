...
1. MUST: All user input from web forms, API requests, and external interfaces MUST be captured in dedicated form objects (DTOs) separate from domain entities

## Policy Block

- MUST All user input from web forms, API requests, and external interfaces MUST be captured in dedicated form objects (DTOs) separate from domain entities
