...
1. MUST: Spring Boot MUST be used as the application bootstrapping mechanism with @SpringBootApplication annotation on the main application class

## Policy Block

- MUST Spring Boot MUST be used as the application bootstrapping mechanism with @SpringBootApplication annotation on the main application class
