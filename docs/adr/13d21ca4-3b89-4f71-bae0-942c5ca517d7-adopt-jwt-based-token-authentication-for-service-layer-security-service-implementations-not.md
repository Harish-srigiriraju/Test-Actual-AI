...
1. MUST_NOT: Service implementations MUST NOT implement custom token generation or validation logic outside the centralized JwtTokenService

## Policy Block

- MUST_NOT Service implementations MUST NOT implement custom token generation or validation logic outside the centralized JwtTokenService
