...
1. MUST: JWT tokens MUST contain sufficient claims to identify the authenticated user and their authorization scope

## Policy Block

- MUST JWT tokens MUST contain sufficient claims to identify the authenticated user and their authorization scope
