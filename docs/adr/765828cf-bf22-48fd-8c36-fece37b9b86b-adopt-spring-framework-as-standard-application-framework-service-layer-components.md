...
1. MUST: Service layer components MUST be annotated with @Service and implement business logic through dependency-injected repositories and other services

## Policy Block

- MUST Service layer components MUST be annotated with @Service and implement business logic through dependency-injected repositories and other services
