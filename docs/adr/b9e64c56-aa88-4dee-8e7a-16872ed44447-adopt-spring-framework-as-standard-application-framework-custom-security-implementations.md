...
1. SHOULD: Custom security implementations SHOULD extend Spring Security's UserDetailsService for authentication and authorization

## Policy Block

- SHOULD Custom security implementations SHOULD extend Spring Security's UserDetailsService for authentication and authorization
