...
1. MUST: All service layer implementations requiring authentication MUST use JWT tokens as the primary authentication mechanism

## Policy Block

- MUST All service layer implementations requiring authentication MUST use JWT tokens as the primary authentication mechanism
