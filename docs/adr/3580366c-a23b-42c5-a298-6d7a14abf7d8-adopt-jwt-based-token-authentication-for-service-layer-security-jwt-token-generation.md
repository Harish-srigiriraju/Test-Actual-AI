...
1. MUST: JWT token generation, validation, and parsing MUST be centralized through a dedicated JwtTokenService implementation

## Policy Block

- MUST JWT token generation, validation, and parsing MUST be centralized through a dedicated JwtTokenService implementation
