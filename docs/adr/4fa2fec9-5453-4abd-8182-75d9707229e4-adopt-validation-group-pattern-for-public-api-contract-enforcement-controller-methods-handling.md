...
1. MUST: Controller methods handling public API requests MUST specify the @Validated annotation with appropriate validation groups

## Policy Block

- MUST Controller methods handling public API requests MUST specify the @Validated annotation with appropriate validation groups
