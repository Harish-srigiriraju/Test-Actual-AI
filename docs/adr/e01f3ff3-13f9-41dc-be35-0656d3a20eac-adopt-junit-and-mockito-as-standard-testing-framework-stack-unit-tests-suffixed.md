...
1. MUST: Unit tests MUST be suffixed with 'Test' (e.g., UserServiceTest.java) to follow standard naming conventions

## Policy Block

- MUST Unit tests MUST be suffixed with 'Test' (e.g., UserServiceTest.java) to follow standard naming conventions
