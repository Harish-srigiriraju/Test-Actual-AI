...
1. SHOULD: Components SHOULD use implicit constructor injection when there is only one constructor (omitting @Autowired annotation as Spring 4.3+ does this automatically)

## Policy Block

- SHOULD Components SHOULD use implicit constructor injection when there is only one constructor (omitting @Autowired annotation as Spring 4.3+ does this automatically)
