...
1. SHOULD: Domain entities used in public APIs SHOULD separate validation constraints by group to avoid over-validation in internal operations

## Policy Block

- SHOULD Domain entities used in public APIs SHOULD separate validation constraints by group to avoid over-validation in internal operations
