...
1. MUST_NOT: Entity classes MUST NOT contain business logic beyond basic validation; complex business operations should reside in service layer components

## Policy Block

- MUST_NOT Entity classes MUST NOT contain business logic beyond basic validation; complex business operations should reside in service layer components
