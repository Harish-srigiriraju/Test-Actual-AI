...
1. MUST_NOT: Classes MUST NOT use System.out.println() or System.err.println() for application logging

## Policy Block

- MUST_NOT Classes MUST NOT use System.out.println() or System.err.println() for application logging
