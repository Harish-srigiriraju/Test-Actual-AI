...
1. MAY: Controllers MAY use @ModelAttribute, @RequestParam, @PathVariable, and @RequestBody annotations for parameter binding as appropriate to the use case

## Policy Block

- MAY Controllers MAY use @ModelAttribute, @RequestParam, @PathVariable, and @RequestBody annotations for parameter binding as appropriate to the use case
