...
1. MUST_NOT: Components MUST NOT use field injection (@Autowired on fields) for required dependencies

## Policy Block

- MUST_NOT Components MUST NOT use field injection (@Autowired on fields) for required dependencies
