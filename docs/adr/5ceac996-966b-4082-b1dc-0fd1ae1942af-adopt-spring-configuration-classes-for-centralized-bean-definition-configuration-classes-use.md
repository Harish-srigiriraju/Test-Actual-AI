...
1. MAY: Configuration classes MAY use @EnableXxx annotations to activate specific Spring features (e.g., @EnableWebMvc, @EnableWebSecurity)

## Policy Block

- MAY Configuration classes MAY use @EnableXxx annotations to activate specific Spring features (e.g., @EnableWebMvc, @EnableWebSecurity)
