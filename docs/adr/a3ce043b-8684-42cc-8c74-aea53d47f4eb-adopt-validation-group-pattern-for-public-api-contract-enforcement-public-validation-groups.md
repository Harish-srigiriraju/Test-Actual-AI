...
1. MUST_NOT: Public API validation groups MUST NOT be reused for internal service-to-service validation to maintain boundary separation

## Policy Block

- MUST_NOT Public API validation groups MUST NOT be reused for internal service-to-service validation to maintain boundary separation
