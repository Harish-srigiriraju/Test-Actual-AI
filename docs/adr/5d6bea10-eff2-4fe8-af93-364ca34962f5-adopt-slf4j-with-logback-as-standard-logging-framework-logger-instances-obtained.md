...
1. MUST: Logger instances MUST be obtained using LoggerFactory.getLogger(ClassName.class) pattern

## Policy Block

- MUST Logger instances MUST be obtained using LoggerFactory.getLogger(ClassName.class) pattern
