...
1. MUST_NOT: Domain entities MUST NOT be directly bound to HTTP request parameters without an intermediate validated form object

## Policy Block

- MUST_NOT Domain entities MUST NOT be directly bound to HTTP request parameters without an intermediate validated form object
