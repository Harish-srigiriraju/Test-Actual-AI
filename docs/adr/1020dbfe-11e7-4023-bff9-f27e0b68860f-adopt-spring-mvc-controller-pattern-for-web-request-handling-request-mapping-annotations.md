...
1. MUST: Request mapping annotations (@RequestMapping, @GetMapping, @PostMapping, etc.) MUST be used to declare URL routes and HTTP methods

## Policy Block

- MUST Request mapping annotations (@RequestMapping, @GetMapping, @PostMapping, etc.) MUST be used to declare URL routes and HTTP methods
