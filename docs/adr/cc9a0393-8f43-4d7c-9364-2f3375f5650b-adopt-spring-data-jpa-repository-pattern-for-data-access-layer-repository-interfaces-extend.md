...
1. MUST: Repository interfaces MUST extend one of the Spring Data repository interfaces (CrudRepository, JpaRepository, or PagingAndSortingRepository)

## Policy Block

- MUST Repository interfaces MUST extend one of the Spring Data repository interfaces (CrudRepository, JpaRepository, or PagingAndSortingRepository)
