...
1. MUST: Form objects MUST declare validation constraints using JSR-303/JSR-380 annotations (@NotNull, @NotEmpty, @Size, @Pattern, @Email, etc.) on all fields

## Policy Block

- MUST Form objects MUST declare validation constraints using JSR-303/JSR-380 annotations (@NotNull, @NotEmpty, @Size, @Pattern, @Email, etc.) on all fields
