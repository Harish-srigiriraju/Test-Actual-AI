...
1. MAY: Validation groups MAY be composed hierarchically for shared validation rules across related operations

## Policy Block

- MAY Validation groups MAY be composed hierarchically for shared validation rules across related operations
