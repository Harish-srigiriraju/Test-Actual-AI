...
1. SHOULD: Integration tests SHOULD test complete workflows across multiple components or layers

## Policy Block

- SHOULD Integration tests SHOULD test complete workflows across multiple components or layers
