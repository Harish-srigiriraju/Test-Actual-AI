...
1. SHOULD: Entity classes SHOULD use @Table annotation to explicitly map to database tables when table names differ from entity class names

## Policy Block

- SHOULD Entity classes SHOULD use @Table annotation to explicitly map to database tables when table names differ from entity class names
