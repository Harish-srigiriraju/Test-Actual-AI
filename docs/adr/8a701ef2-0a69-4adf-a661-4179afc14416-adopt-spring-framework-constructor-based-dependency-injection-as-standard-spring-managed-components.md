...
1. MUST: All Spring-managed components (services, validators, controllers, configuration classes) MUST use constructor-based dependency injection for required dependencies

## Policy Block

- MUST All Spring-managed components (services, validators, controllers, configuration classes) MUST use constructor-based dependency injection for required dependencies
