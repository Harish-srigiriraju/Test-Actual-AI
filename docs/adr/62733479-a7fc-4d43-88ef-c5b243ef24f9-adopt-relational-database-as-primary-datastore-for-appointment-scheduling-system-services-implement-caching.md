...
1. MAY: Services MAY implement caching layers above the primary datastore for read-heavy access patterns, but the relational database remains the source of truth

## Policy Block

- MAY Services MAY implement caching layers above the primary datastore for read-heavy access patterns, but the relational database remains the source of truth
