...
1. SHOULD: Complex queries that cannot be derived from method names SHOULD use @Query annotation with JPQL or native SQL

## Policy Block

- SHOULD Complex queries that cannot be derived from method names SHOULD use @Query annotation with JPQL or native SQL
