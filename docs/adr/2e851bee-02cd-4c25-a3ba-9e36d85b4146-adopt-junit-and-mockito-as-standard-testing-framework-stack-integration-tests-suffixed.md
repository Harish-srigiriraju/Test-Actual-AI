...
1. MUST: Integration tests MUST be suffixed with 'IT' (e.g., UserServiceIT.java) to distinguish them from unit tests

## Policy Block

- MUST Integration tests MUST be suffixed with 'IT' (e.g., UserServiceIT.java) to distinguish them from unit tests
