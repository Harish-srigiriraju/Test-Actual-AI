...
1. MUST: Entity classes MUST define a primary key using @Id annotation, with generation strategy specified via @GeneratedValue where applicable

## Policy Block

- MUST Entity classes MUST define a primary key using @Id annotation, with generation strategy specified via @GeneratedValue where applicable
