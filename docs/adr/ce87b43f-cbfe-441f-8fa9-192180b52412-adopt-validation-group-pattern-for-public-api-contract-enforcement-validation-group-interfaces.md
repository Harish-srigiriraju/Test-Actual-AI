...
1. MUST: Validation group interfaces MUST be defined in a dedicated validation.groups package to maintain clear separation from domain entities

## Policy Block

- MUST Validation group interfaces MUST be defined in a dedicated validation.groups package to maintain clear separation from domain entities
