...
1. SHOULD: Configuration classes SHOULD be placed in dedicated config or security packages to maintain clear separation of concerns

## Policy Block

- SHOULD Configuration classes SHOULD be placed in dedicated config or security packages to maintain clear separation of concerns
