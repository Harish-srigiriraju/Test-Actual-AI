...
1. MAY: Entities MAY use inheritance strategies (@Inheritance) for modeling entity hierarchies such as user type specializations

## Policy Block

- MAY Entities MAY use inheritance strategies (@Inheritance) for modeling entity hierarchies such as user type specializations
