...
1. SHOULD: Validation groups SHOULD follow the naming convention: {Action}{EntityType} (e.g., CreateCorporateCustomer, UpdateAppointment)

## Policy Block

- SHOULD Validation groups SHOULD follow the naming convention: {Action}{EntityType} (e.g., CreateCorporateCustomer, UpdateAppointment)
