...
1. MAY: UI tests MAY use additional frameworks (e.g., Selenium) in conjunction with JUnit for browser automation

## Policy Block

- MAY UI tests MAY use additional frameworks (e.g., Selenium) in conjunction with JUnit for browser automation
