...
1. SHOULD: Entity classes SHOULD use JPA annotations (@Entity, @Table, @Id) for ORM mapping and be managed by Spring Data repositories

## Policy Block

- SHOULD Entity classes SHOULD use JPA annotations (@Entity, @Table, @Id) for ORM mapping and be managed by Spring Data repositories
