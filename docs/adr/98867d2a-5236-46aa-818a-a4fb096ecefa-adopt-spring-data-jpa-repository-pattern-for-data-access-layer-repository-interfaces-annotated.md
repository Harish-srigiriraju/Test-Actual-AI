...
1. MUST: Repository interfaces MUST be annotated with @Repository or rely on Spring Data's component scanning

## Policy Block

- MUST Repository interfaces MUST be annotated with @Repository or rely on Spring Data's component scanning
