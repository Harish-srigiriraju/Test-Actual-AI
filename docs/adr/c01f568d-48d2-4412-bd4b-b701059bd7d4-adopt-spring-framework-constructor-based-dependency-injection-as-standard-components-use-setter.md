...
1. MAY: Components MAY use setter injection only for optional dependencies that have reasonable defaults

## Policy Block

- MAY Components MAY use setter injection only for optional dependencies that have reasonable defaults
