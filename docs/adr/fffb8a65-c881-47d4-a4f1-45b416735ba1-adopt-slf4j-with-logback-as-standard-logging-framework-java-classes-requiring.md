...
1. MUST: All Java classes requiring logging capabilities MUST use SLF4J (Simple Logging Facade for Java) as the logging API

## Policy Block

- MUST All Java classes requiring logging capabilities MUST use SLF4J (Simple Logging Facade for Java) as the logging API
