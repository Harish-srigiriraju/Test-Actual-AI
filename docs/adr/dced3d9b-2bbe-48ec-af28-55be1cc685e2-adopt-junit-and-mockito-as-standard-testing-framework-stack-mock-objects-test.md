...
1. MUST: Mock objects and test doubles MUST be created using Mockito framework for dependency isolation

## Policy Block

- MUST Mock objects and test doubles MUST be created using Mockito framework for dependency isolation
