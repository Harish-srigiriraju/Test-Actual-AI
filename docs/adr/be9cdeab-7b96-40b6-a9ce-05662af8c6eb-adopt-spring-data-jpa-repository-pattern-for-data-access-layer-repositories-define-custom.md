...
1. MAY: Repositories MAY define custom query methods beyond the standard CRUD operations provided by the base interface

## Policy Block

- MAY Repositories MAY define custom query methods beyond the standard CRUD operations provided by the base interface
