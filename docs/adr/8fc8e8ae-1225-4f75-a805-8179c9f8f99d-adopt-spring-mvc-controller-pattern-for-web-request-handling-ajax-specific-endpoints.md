...
1. SHOULD: AJAX-specific endpoints SHOULD be separated into dedicated controller classes (e.g., AjaxController) or clearly marked with appropriate annotations

## Policy Block

- SHOULD AJAX-specific endpoints SHOULD be separated into dedicated controller classes (e.g., AjaxController) or clearly marked with appropriate annotations
