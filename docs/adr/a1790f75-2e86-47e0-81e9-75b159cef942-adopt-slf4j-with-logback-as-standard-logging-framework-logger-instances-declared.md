...
1. MUST: Logger instances MUST be declared as private static final fields with the naming convention 'logger' or 'log'

## Policy Block

- MUST Logger instances MUST be declared as private static final fields with the naming convention 'logger' or 'log'
