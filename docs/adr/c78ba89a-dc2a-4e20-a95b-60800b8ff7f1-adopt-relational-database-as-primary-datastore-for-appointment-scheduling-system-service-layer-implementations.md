...
1. SHOULD: Service layer implementations SHOULD access the database through repository abstractions or data access objects to maintain separation of concerns

## Policy Block

- SHOULD Service layer implementations SHOULD access the database through repository abstractions or data access objects to maintain separation of concerns
