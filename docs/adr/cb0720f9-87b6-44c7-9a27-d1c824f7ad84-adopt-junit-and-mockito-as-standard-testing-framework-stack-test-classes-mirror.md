...
1. SHOULD: Test classes SHOULD mirror the package structure of the production code they test

## Policy Block

- SHOULD Test classes SHOULD mirror the package structure of the production code they test
