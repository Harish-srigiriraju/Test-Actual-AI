...
1. SHOULD: Cascade types and fetch strategies SHOULD be explicitly specified on relationship annotations to control persistence behavior and performance characteristics

## Policy Block

- SHOULD Cascade types and fetch strategies SHOULD be explicitly specified on relationship annotations to control persistence behavior and performance characteristics
